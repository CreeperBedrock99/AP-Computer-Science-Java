...
class starter {
		...
		*/
		while(true){
			...
			if (choice.equals("file")){
				...
				System.out.println("\'" + check + "\' appears " + checksArray(arr, check) + " times in " + textFile + ".");
	...
	*/
	public static int checksArray(String[] arr, String check){
		...
		return occurences;	// Dummy value, delete when needed.
	}
	...
	*/
	public static String mostCommon(String[] arr){
		...
		for (int x = 0; x < arr.length; x++){
			...
			if (wordCount[x] > commonPlace){
				commonPlace = x;
			}
		}
		String commonWord = arr[commonPlace];
